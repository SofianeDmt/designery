      ...
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            ...
            <div className="max-w-full lg:max-w-md mt-4 text-gray-500 dark:text-gray-400 justify-center items-center lg:justify-start flex text-center">
              Nous somme disponible 7/7j pour toutes demandes de devis ou questions.
            </div>
...
{/*            <div className="mt-5">
            ...
            <div className="flex flex-wrap w-full -mt-2 -ml-3 lg:ml-0">
              {legal.map((item, index) => (
                <Link legacyBehavior key={index} href="/">
                  <a className="w-full px-4 py-2 text-gray-500 rounded-md dark:text-gray-300 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 focus:outline-none dark:focus:bg-trueGray-700 justify-center items-center lg:justify-start flex text-center">
                    {item}
                  </a>
                </Link>
              ))}
          ...
          <div className="-ml-5 justify-center items-center lg:justify-start flex flex-col text-center">
            <div>Suivez nous</div>
